...
for (const marker of ['style.css?v=1.0.0', 'readability.css?v=1.0.0', 'visualizer.css?v=1.0.0', 'three.min.js?v=1.0.0', 'app.js?v=1.0.0']) {
  if (!html.includes(marker)) throw Error(`missing 1.0.0 cache key ${marker}`);
}
...
if (!main.includes('songloft-now-playing 1.0.0 initialized')) throw Error('stale main entry identity');

console.log('songloft-now-playing 1.0.0 package identity, description, cache keys, hashes, structure, and runtime markers are valid.');